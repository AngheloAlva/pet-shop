...
const page = (): JSX.Element => {
  return (
    <>
      ...
      <div className='flex justify-center items-center gap-5 -mt-10 relative flex-col'>
        <div className='w-80 border-2 rounded-lg border-[--bg-300] overflow-hidden h-[27rem] flex flex-col'>
